...
const status = ['reviewed', 'unreviewed']
...
export default function EnhancedTable(props) {
    ...
    const [updateCounter, setUpdateCounter] = React.useState('');
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{capitalizeFirstLetter(row.name)}</TableCell>
                                            <TableCell align="right">{row.number}</TableCell>
                                            <TableCell align="right">{row.creationDate}</TableCell>
                                            <TableCell align="right">{row.updationDate}</TableCell>
